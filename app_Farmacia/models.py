...
class VentaFarmacia(models.Model):
    ...
    def __str__(self):
        return f"Venta #{self.id} - Factura: {self.numero_factura}"

# ===================
# TABLA 7: DETALLE VENTA FARMACIA
# ===================
class DetalleVentaFarmacia(models.Model):
    ...
    receta_asociada = models.ForeignKey(
        RecetaMedica,
        on_delete=models.SET_NULL,
        null=True,
        blank=True
